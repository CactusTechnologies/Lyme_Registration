...
class App extends Component {
    ...
    componentDidMount() {
        ...
        fetch('http://10.0.55.10:3030/user/check')
            .then(res => res.json())
            .then(
                (result) => {
                    console.log(result)
                    if (result.hasUser) this.setState({ vacant: false })
                    else this.setState({ vacant: true })
                },
                (error) => {
                    console.log(error)
                }
    ...
    handleSumbit() {
        ...
        fetch('http://10.0.55.10:3030/user/new', {
            method: 'POST',
            headers: {
    ...
    render() {
        return (
            <div className="App">
                <Websocket
                    url="ws://10.0.55.10:9000/registration"
